...
public class Currency {
	...
	public void defaultValues() {
		...
		switch (currency) {	
			case "US Dollar":
				...
				this.exchangeValues.put("Rs", 74.53);
				break;
			case "Euro":
				...
				this.exchangeValues.put("Rs", 188.07);
				break;
			case "British Pound":
				...
				this.exchangeValues.put("Rs",103.19);
				break;
			case "Swiss Franc":
				...
				this.exchangeValues.put("Rs", 81.30);
				break;
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("Rs", 11.52);
				break;
			case "Japanese Yen":
				...
				this.exchangeValues.put("Rs", 0.68);
				break;
			case "India Rs":
				this.exchangeValues.put("USD",74.53 );
				this.exchangeValues.put("EUR", 188.07);
				this.exchangeValues.put("GBP", 103.19);
				this.exchangeValues.put("CHF", 81.30);
				this.exchangeValues.put("CNY", 11.52);
				this.exchangeValues.put("JPY", 0.68);
				this.exchangeValues.put("Rs", 1.00);
				break;
		}
	}
	...
	public static ArrayList<Currency> init() {
		...
		currencies.add( new Currency("India Rs", "Rs") );
